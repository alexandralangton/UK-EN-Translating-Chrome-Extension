!(function (e, t) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		? define(t)
		: ((e =
				'undefined' != typeof globalThis ? globalThis : e || self).nlp = t());
})(this, function () {
	'use strict';
	...
	const c = /[a-z\u00C0-\u00FF] ?\/ ?[a-z\u00C0-\u00FF]/;
	var h = function (e) {
		let t = (e = (e = (e = e || '').toLowerCase()).trim());
		return (
			(e = n(e)),
			!0 === c.test(e) && (e = e.replace(/\/.*/, '')),
	...
	var w = (e) => {
		...
		'' ===
			...
			(a = a));
		let n = h(e);
		const i = { text: e, clean: n, reduced: d(n), pre: r, post: a };
		return (
			m.test(e) &&
				e.split(m).forEach((e) => {
	...
	var A = k(function (e, t) {
		...
		D = k(function (e, t) {
			...
			(t.hasPost = function (e) {
				...
				(t.hasQuote = function () {
					return r.test(this.pre) || a.test(this.post);
				}),
	...
	P = function (e, t, r, a) {
		let n = (function (e, t, r, a) {
			...
			if (void 0 !== t.word) {
				...
				if (void 0 !== t.fuzzy) {
					let r = $(t.word, e.reduced);
					if (r > t.fuzzy) return !0;
					if (!0 === t.soft && ((r = $(t.word, e.root)), r > t.fuzzy))
						return !0;
				}
			...
			return void 0 !== t.tag
				...
				: void 0 !== t.choices &&
				  ('and' === t.operator
						? t.choices.every((t) => P(e, t, r, a))
						: t.choices.some((t) => P(e, t, r, a)));
		})(e, t, r, a);
	...
	var j = {
		...
		isKnown: function () {
			return Object.keys(this.tags).some((e) => !0 !== H[e]);
		},
		setRoot: function (e) {
			let t = e.transforms,
	...
	const C = { Auxiliary: 1, Possessive: 1 };
	var B = function (e, t) {
	...
	var z = {
			json: function (e, t) {
				...
				let r = {};
				return (
					(e = Object.assign({}, G, e)).text && (r.text = this.text),
					...
					e.bestTag && (r.bestTag = B(this, t)[0]),
					r
				);
			},
		},
		I = Object.assign({}, A, D, j, F, z);
	function O() {
	...
	var V = function (e, t, r) {
			...
			let a = '[33m' + T(e.clean, 15) + '[0m + [32m' + t + '[0m ';
			r && (a = T(a, 35) + ' ' + r), console.log(a);
		},
		M = function (e, t, r) {
			if (O())
				return void console.log(
			...
			let a = '[33m' + T(e.clean, 3) + ' [31m - #' + t + '[0m ';
			r && (a = T(a, 35) + ' ' + r), console.log(a);
		},
		J = (e) => e.charAt(0).toUpperCase() + e.substr(1);
	const L = function (e, t, r, a) {
		let n = a.tags;
		if ('' === t || '.' === t || '-' === t) return;
		if (
			('#' === t[0] && (t = t.replace(/^#/, '')), (t = J(t)), !0 === e.tags[t])
		)
			return;
		const i = a.isVerbose();
		!0 === i && V(e, t, r),
			...
			!0 === n.hasOwnProperty(t) &&
				(n[t].isA.forEach((t) => {
					(e.tags[t] = !0), !0 === i && V(e, '→ ' + t);
				}),
				e.unTag(n[t].notA, '←', a));
	};
	var S = function (e, t, r, a) {
		if ('string' != typeof t)
			for (let n = 0; n < t.length; n++) L(e, t[n], r, a);
		else L(e, t, r, a);
	};
	const _ = /^[a-z]/,
		K = function (e, t, r, a) {
			...
			var i;
			(t = t.replace(/^#/, '')),
				!0 === _.test(t) && (t = (i = t).charAt(0).toUpperCase() + i.substr(1)),
				!0 === e.tags[t] && (delete e.tags[t], !0 === n && M(e, t, r));
			const o = a.tags;
			if (o[t]) {
				let r = o[t].lineage;
				for (let t = 0; t < r.length; t++)
					!0 === e.tags[r[t]] &&
						(delete e.tags[r[t]], !0 === n && M(e, ' - ' + r[t]));
			}
			return e;
		};
	...
	const W = function (e, t, r) {
		...
		return void 0 === a[t].isA || W(e, a[t].isA, r);
	};
	var R = W,
		U = {
			tag: function (e, t, r) {
				return S(this, e, t, r), this;
			},
			tagSafe: function (e, t, r) {
				return R(this, e, r) && S(this, e, t, r), this;
			},
	...
	const te = /[.?!]\s*$/,
		re = function (e, t) {
			...
			let r = e[e.length - 1],
				a = t[t.length - 1];
			(a.post = (function (e, t) {
				if (te.test(t)) return t + e.match(/\s*$/);
				return e;
			})(r.post, a.post)),
				(r.post = ''),
				'' === r.post && (r.post += ' ');
	...
	var oe = function (e, t) {
		...
		ce = Object.assign({}, X, Y, ee, se, le, ue);
	var he = function (e, t) {
		...
		de = k(function (e, t) {
			(t.getGreedy = function (e, t) {
				...
				for (; e.t < e.terms.length; e.t += 1) {
					...
					if (
						!1 === e.terms[e.t].doesMatch(r, e.start_i + e.t, e.phrase_length)
					)
						return void 0 !== r.min && n < r.min ? null : e.t;
				}
				return e.t;
			}),
				(t.greedyTo = function (e, t) {
					let r = e.t;
				...
				(t.doOrBlock = function (e, r = 0) {
					let a = e.regs[e.r],
						n = !1;
					for (let t = 0; t < a.choices.length; t += 1) {
						let i = a.choices[t];
						if (
							((n = i.every((t, a) => {
								let n = 0,
								...
								let o = e.terms[i].doesMatch(t, i + e.start_i, e.phrase_length);
								if (!0 === o && !0 === t.greedy)
									for (let r = 1; r < e.terms.length; r += 1) {
										let a = e.terms[i + r];
										if (a) {
											if (!0 !== a.doesMatch(t, e.start_i + r, e.phrase_length))
												break;
											n += 1;
										}
									}
					...
					return n && !0 === a.greedy ? t.doOrBlock(e, r) : r;
				}),
				(t.doAndBlock = function (e) {
					let t = 0;
					return (
						!0 ===
	...
	var ge = function (e, r, a, n) {
		...
		for (; i.r < r.length; i.r += 1) {
			...
			if (
				...
				const a = r[i.r - 1];
				a && a.named === e.named && i.previousGroup
					? (i.groupId = i.previousGroup)
					: ((i.groupId = t(e.named)), (i.previousGroup = i.groupId));
			}
			if (!i.terms[i.t]) {
				if (!1 === r.slice(i.r).some((e) => !e.optional)) break;
				return null;
			}
			if (!0 === e.anything && !0 === e.greedy) {
				let t = de.greedyTo(i, r[i.r + 1]);
				if (null === t || 0 === t) return null;
				if (void 0 !== e.min && t - i.t < e.min) return null;
				if (void 0 !== e.max && t - i.t > e.max) {
					i.t = i.t + e.max;
					continue;
				}
				if (!0 === i.hasGroup) {
					de.getGroup(i, i.t, e.named).length = t - i.t;
				}
				i.t = t;
				continue;
			}
			if (void 0 !== e.choices && 'or' === e.operator) {
				let t = de.doOrBlock(i);
				if (t) {
					if (!0 === e.negative) return null;
					if (!0 === i.hasGroup) {
						de.getGroup(i, i.t, e.named).length += t;
					}
					i.t += t;
					continue;
				}
			...
			let a = i.terms[i.t],
				o = a.doesMatch(e, i.start_i + i.t, i.phrase_length);
			if (!0 === e.anything || !0 === o || de.isEndGreedy(e, i)) {
				let t = i.t;
				if (e.optional && r[i.r + 1] && e.negative) continue;
				if (e.optional && r[i.r + 1]) {
					let t = a.doesMatch(r[i.r + 1], i.start_i + i.t, i.phrase_length);
					if (e.negative || t) {
						let e = i.terms[i.t + 1];
						(e && e.doesMatch(r[i.r + 1], i.start_i + i.t, i.phrase_length)) ||
							(i.r += 1);
					}
				}
				if (
					((i.t += 1),
					!0 === e.end && i.t !== i.terms.length && !0 !== e.greedy)
				)
					return null;
				if (!0 === e.greedy) {
					if (((i.t = de.getGreedy(i, r[i.r + 1])), null === i.t)) return null;
					if (e.min && e.min > i.t) return null;
					if (!0 === e.end && i.start_i + i.t !== n) return null;
				}
				if (!0 === i.hasGroup) {
					const r = de.getGroup(i, t, e.named);
					i.t > 1 && e.greedy ? (r.length += i.t - t) : r.length++;
				}
			} else {
				if (e.negative) {
					...
					if (
						((t.negative = !1),
						!0 === i.terms[i.t].doesMatch(t, i.start_i + i.t, i.phrase_length))
					)
						return null;
				}
				if (!0 !== e.optional) {
					if (i.terms[i.t].isImplicit() && r[i.r - 1] && i.terms[i.t + 1]) {
						if (
							i.terms[i.t - 1] &&
							i.terms[i.t - 1].implicit === r[i.r - 1].word
						)
							return null;
						if (
							i.terms[i.t + 1].doesMatch(e, i.start_i + i.t, i.phrase_length)
						) {
							i.t += 2;
							continue;
						}
	...
	var we = function (e) {
		let t = e.split(me),
			r = [];
		t.forEach((e) => {
			ye(e) ? r.push(e) : (r = r.concat(e.split(fe)));
		}),
			(r = ve(r));
		let a = [];
		return (
	...
	const ke = /\{([0-9]+,?[0-9]*)\}/,
		...
		Ne = function (e) {
			...
			for (let r = 0; r < 2; r += 1) {
				if (
					('$' === $e(e) && ((t.end = !0), (e = He(e))),
					'^' === Pe(e) && ((t.start = !0), (e = Ee(e))),
					('[' === Pe(e) || ']' === $e(e)) &&
						((t.named = !0),
						'[' === Pe(e)
							? (t.groupType = ']' === $e(e) ? 'single' : 'start')
							: (t.groupType = 'end'),
				...
				if (
					('+' === $e(e) && ((t.greedy = !0), (e = He(e))),
					'*' !== e &&
						'*' === $e(e) &&
						'\\*' !== e &&
						((t.greedy = !0), (e = He(e))),
					'?' === $e(e) && ((t.optional = !0), (e = He(e))),
					'!' === Pe(e) && ((t.negative = !0), (e = Ee(e))),
					'(' === Pe(e) && ')' === $e(e))
				) {
					Ae.test(e)
						? ((t.choices = e.split(Ae)), (t.operator = 'and'))
						: ((t.choices = e.split('|')), (t.operator = 'or')),
						(t.choices[0] = Ee(t.choices[0]));
					let r = t.choices.length - 1;
					(t.choices[r] = He(t.choices[r])),
						(t.choices = t.choices.map((e) => e.trim())),
						(t.choices = t.choices.filter((e) => e)),
						(t.choices = t.choices.map((e) => e.split(/ /g).map(Ne))),
						(e = '');
				}
				if ('/' === Pe(e) && '/' === $e(e))
					return (e = je(e)), (t.regex = new RegExp(e)), t;
				if ('~' === Pe(e) && '~' === $e(e))
					return (e = je(e)), (t.soft = !0), (t.word = e), t;
			}
			return (
				!0 === ke.test(e) &&
					(e = e.replace(ke, (e, r) => {
	...
	var Ge = function (e, t, r = !1) {
		if (('string' == typeof t && (t = Ce(t)), !0 === he(e, t))) return [];
		const a = t.filter((e) => !0 !== e.optional && !0 !== e.negative).length;
		let n = e.terms(),
			i = [];
		if (t[0].idBlocks) {
			let e = Be(n, t);
			if (e && e.length > 0) return pe(n, t, e);
		}
		if (!0 === t[0].start) {
			let e = ge(n, t, 0, n.length);
			return (
				e &&
					e.match &&
					e.match.length > 0 &&
		...
		for (let e = 0; e < n.length && !(e + a > n.length); e += 1) {
			let a = ge(n.slice(e), t, e, n.length);
			if (
				a &&
				a.match &&
				a.match.length > 0 &&
	...
	(Oe.prototype.buildFrom = function (e, t, r) {
		let a = new Oe(e, t, this.pool);
		return (
		...
		Object.assign(Oe.prototype, Ie),
		Object.assign(Oe.prototype, ce);
	const Te = { term: 'terms' };
	Object.keys(Te).forEach((e) => (Oe.prototype[e] = Oe.prototype[Te[e]]));
	var Ve = Oe;
	class Me {
		constructor(e = {}) {
	...
	const Se = /(\S.+?[.!?\u203D\u2E18\u203C\u2047-\u2049])(?=\s+|$)/g,
		...
		Ue = /^\s+/,
		Qe = function (e, t) {
			if (!0 === Ke.test(e)) return !1;
			if (!0 === qe.test(e)) return !1;
			if (!1 === Re.test(e)) return !1;
			let r = e
					.replace(/[.!?\u203D\u2E18\u203C\u2047-\u2049] *$/, '')
					.split(' '),
				a = r[r.length - 1].toLowerCase();
	...
	var Ze = function (e, t) {
		...
		let a = [],
			n = [];
		if (!(e = String(e)) || 'string' != typeof e || !1 === _e.test(e)) return a;
		let i = (function (e) {
			let t = [],
				r = e.split(We);
		...
		for (let e = 0; e < n.length; e++) {
			...
			n[e + 1] && !1 === Qe(t, r)
				? (n[e + 1] = t + (n[e + 1] || ''))
				: t && t.length > 0 && (a.push(t), (n[e] = ''));
		}
		if (0 === a.length) return [e];
		for (let e = 1; e < a.length; e += 1) {
			let t = a[e].match(Ue);
			null !== t && ((a[e - 1] += t[0]), (a[e] = a[e].replace(Ue, '')));
		}
		return a;
	};
	const Xe = /\S/,
	...
	var it = function (e) {
		...
		for (let e = 0; e < a.length; e++)
			!0 !== at(a[e]) ? r.push(a[e]) : (r = r.concat(nt(a[e])));
		let n = '';
		for (let e = 0; e < r.length; e++) {
			let a = r[e];
			!0 === Xe.test(a) && !1 === rt.hasOwnProperty(a) && !1 === Ye.test(a)
		...
		return (
			...
			a.map((e) => {
				(e = e.map((e) => {
					...
					Le(e);
				let t = new Ve(e[0].id, e.length, r);
	...
	var st = function (e, t) {
		...
		return e.map((e, a) => {
			...
			return Le(n), new Ve(n[0].id, n.length, r);
		});
	};
	const lt = ['Person', 'Place', 'Organization'];
	var ut = {
			...
			Pronoun: { isA: 'Noun', notA: lt },
			Actor: { isA: 'Noun', notA: lt },
			Activity: { isA: 'Noun', notA: ['Person', 'Place'] },
			Unit: { isA: 'Noun', notA: lt },
			Demonym: { isA: ['Noun', 'ProperNoun'], notA: lt },
			Possessive: { isA: 'Noun' },
		},
		ct = {
	...
	const dt = ['Noun', 'Verb', 'Adjective', 'Adverb', 'Value', 'QuestionWord'];
	var gt = {
		...
		Emoticon: { notA: ['HashTag', 'Verb', 'Adjective', 'Value', 'AtMention'] },
		...
		return (
			Object.keys(e).forEach((t) => {
				e[t].color
					...
					: pt[t]
					? (e[t].color = pt[t])
					: e[t].isA.some((r) => !!pt[r] && ((e[t].color = pt[r]), !0));
			}),
			e
		);
	};
	...
	var kt = (() => {
			let e = {};
			return wt(ut, e), wt(ct, e), wt(ht, e), wt(gt, e), (e = vt(e)), e;
		})(),
		At = {
			...
			Value: 'true¦a few',
			Noun:
				'true¦a5b4c2f1here,ie,lit,m0no doubt,pd,tce;a,d;t,y;a,ca,o0;l,rp;a,l;d,l,rc',
			...
			Adverb:
				'true¦a08by 06d02eYfShQinPjustOkinda,mMnJoEpCquite,r9s5t2up1very,well,ye0;p,s; to,wards5;h1iny bit,o0wiO;o,t6ward;en,us;everal,o0uch;!me1rt0; of;hYtimes,w09;a1e0;alT;ndomSthN;ar excellDer0oint blank; Nhaps;f3n0;ce0ly;! 0;ag02moW; courIten;ewKo0; longEt 0;onIwithstanding;aybe,eanwhiAore0;!ovB;! aboU;deed,steV;en0;ce;or2u0;lArther0;!moJ; 0ev3;examp0good,suH;le;n1v0;er; mas0ough;se;e0irect1; 1finite0;ly;ju8trop;far,n0;ow; DbroCd nauseam,gBl6ny3part,s2t 0w4;be6l0mo6wor6;arge,ea5; soon,ide;mo1w0;ay;re;l 1mo0one,ready,so,ways;st;b1t0;hat;ut;ain;ad;lot,posteriori',
			Determiner:
				'true¦aAboth,d8e5few,l3mu7neiCown,plenty,some,th2various,wh0;at0ich0;evB;at,e3is,ose;a,e0;!ast,s;a1i6l0very;!se;ch;e0u;!s;!n0;!o0y;th0;er',
		};
	const Dt = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ',
		$t = Dt.split('').reduce(function (e, t, r) {
			return (e[t] = r), e;
		}, {});
	var Pt = function (e) {
	...
	var Vt = {
		...
		s: [
			{ reg: /(ish|tch|ess)$/i, repl: { pr: '$1es', pa: '$1ed', gr: '$1ing' } },
		],
		t: [
			{
		...
		y: [
			{ reg: /(i|f|rr)y$/i, repl: { pr: '$1ies', pa: '$1ied', gr: '$1ying' } },
		],
		z: [
	...
	const Mt = {
		...
		Jt = function (e, t) {
			...
			for (let n = 0; n < a.length; n += 1) {
				let i = a[n];
				r[Mt[i]] = e.replace(t.reg, t.repl[i]);
			}
			return r;
		};
	var Lt = function (e = '') {
		...
		if (!0 === Vt.hasOwnProperty(t))
			for (let r = 0; r < Vt[t].length; r += 1) {
				if (!0 === Vt[t][r].reg.test(e)) return Jt(e, Vt[t][r]);
			}
		return {};
	};
	const St = /[bcdfghjklmnpqrstvwxz]y$/;
	var _t = {
		Gerund: (e) =>
	...
	var Kt = function (e = '', t) {
		...
		return (
			...
			(r = Object.assign({}, Lt(e), r)),
			void 0 === r.Gerund && (r.Gerund = _t.Gerund(e)),
			void 0 === r.PastTense && (r.PastTense = _t.PastTense(e)),
			void 0 === r.PresentTense && (r.PresentTense = _t.PresentTense(e)),
			r
		);
	};
	const qt = [
	...
	const er = {
		toSuperlative: function (e) {
			if (Rt.hasOwnProperty(e)) return Rt[e];
			for (let t = 0; t < Ut.length; t++)
				if (Ut[t].reg.test(e)) return e.replace(Ut[t].reg, Ut[t].repl);
			for (let t = 0; t < Wt.length; t++) if (!0 === Wt[t].test(e)) return null;
		...
		toComparative: function (e) {
			...
			for (let t = 0; t < Yt.length; t++)
				if (!0 === Yt[t].reg.test(e)) return e.replace(Yt[t].reg, Yt[t].repl);
			for (let t = 0; t < Zt.length; t++) if (!0 === Zt[t].test(e)) return null;
			for (let t = 0; t < Qt.length; t++)
				if (!0 === Qt[t].test(e)) return e + 'er';
			return !0 === /e$/.test(e) ? e + 'r' : e + 'er';
		},
	};
	var tr = function (e) {
		let t = {},
			r = er.toSuperlative(e);
		r && (t.Superlative = r);
		let a = er.toComparative(e);
	...
	const ar = /(x|ch|sh|s|z)$/;
	var nr = function (e = '', t) {
			let r = t.irregulars.nouns;
			if (r.hasOwnProperty(e)) return r[e];
			let a = (function (e) {
				let t = e[e.length - 1];
				if (!0 === rr.hasOwnProperty(t))
					for (let r = 0; r < rr[t].length; r += 1) {
						let a = rr[t][r][0];
						if (!0 === a.test(e)) return e.replace(a, rr[t][r][1]);
					}
				return null;
			})(e);
			return null !== a ? a : ar.test(e) ? e + 'es' : e + 's';
		},
		ir = [
			[/([^v])ies$/i, '$1y'],
			[/ises$/i, 'isis'],
	...
	var or = function (e, t) {
		...
		for (let t = 0; t < ir.length; t++)
			if (!0 === ir[t][0].test(e)) return (e = e.replace(ir[t][0], ir[t][1]));
		return e;
	};
	var sr = {
		Participle: [
				...
				if (
					(r =
						...
						(function (e) {
							...
							if (!0 === ur.hasOwnProperty(t)) return ur[t];
							let r = e.substr(e.length - 2);
							return !0 === ur.hasOwnProperty(r)
								? ur[r]
	...
	gr.prototype.clone = function () {
		...
		return (
			...
			(e.irregulars = pr(this.irregulars)),
			(e.tags = pr(this.tags)),
	...
	var mr = gr,
		...
		br = k(function (e, t) {
			(t.first = function (e) {
				...
				(t.get = t.eq),
				(t.firstTerms = function () {
					return this.match('^.');
				}),
				(t.firstTerm = t.firstTerms),
				(t.lastTerms = function () {
					return this.match('.$');
				}),
				(t.lastTerm = t.lastTerms),
	...
	var yr = function (e, t) {
		...
		vr = k(function (e, t) {
			(t.match = function (e, t = {}) {
				...
				if (!1 === yr(this, r)) return this.buildFrom([]);
				let a = this.list.reduce((e, t) => e.concat(t.match(r)), []);
				return void 0 !== t.group && null !== t.group && '' !== t.group
					? this.buildFrom(a).groups(t.group)
					: this.buildFrom(a);
			}),
				(t.not = function (e, t = {}) {
					let r = Ce(e, t);
					if (0 === r.length || !1 === yr(this, r)) return this;
					let a = this.list.reduce((e, t) => e.concat(t.not(r)), []);
					return this.buildFrom(a);
				}),
				(t.matchOne = function (e, t = {}) {
					let r = Ce(e, t);
					if (!1 === yr(this, r)) return this.buildFrom([]);
					for (let e = 0; e < this.list.length; e++) {
						let t = this.list[e].match(r, !0);
						return this.buildFrom(t);
					}
				...
				(t.if = function (e, t = {}) {
					let r = Ce(e, t);
					if (!1 === yr(this, r)) return this.buildFrom([]);
					let a = this.list.filter((e) => !0 === e.has(r));
					return this.buildFrom(a);
				}),
				(t.ifNo = function (e, t = {}) {
					let r = Ce(e, t),
						a = this.list.filter((e) => !1 === e.has(r));
					return this.buildFrom(a);
				}),
				(t.has = function (e, t = {}) {
					let r = Ce(e, t);
					return !1 !== yr(this, r) && this.list.some((e) => !0 === e.has(r));
				}),
				...
				(t.lookBehind = function (e, t = {}) {
					e || (e = '.*');
					let r = Ce(e, t),
						a = [];
					return (
						this.list.forEach((e) => {
							a = a.concat(e.lookBehind(r));
						}),
						(a = a.filter((e) => e)),
						this.buildFrom(a)
					);
				...
				(t.before = function (e, t = {}) {
					let r = Ce(e, t),
						a = this.if(r).list.map((e) => {
							let t = e.terms().map((e) => e.id),
								a = e.match(r)[0],
								n = t.indexOf(a.start);
							return 0 === n || -1 === n ? null : e.buildFrom(e.start, n);
						});
					return (a = a.filter((e) => null !== e)), this.buildFrom(a);
				}),
				...
				(t.hasAfter = function (e, t = {}) {
					return this.filter((r) => r.lookAfter(e, t).found);
				}),
				(t.hasBefore = function (e, t = {}) {
	...
	var wr = function (e, t, r, a) {
		...
		kr = {
			tag: function (e, t) {
				return e ? (wr(e, this, !1, t), this) : this;
			},
			tagSafe: function (e, t) {
				return e ? (wr(e, this, !0, t), this) : this;
			},
			unTag: function (e, t) {
				return (
					this.list.forEach((r) => {
	...
	var Dr = function (e, t, r) {
		...
		$r = k(function (e, t) {
			(t.lookup = function (e) {
				let t = [],
					r =
						(a = e) && '[object Object]' === Object.prototype.toString.call(a);
				var a;
				!0 === r && (e = Object.keys(e).map((r) => (t.push(e[r]), r))),
					'string' == typeof e && (e = [e]),
				...
				if (!0 === r) {
					...
					return (
						n.forEach((t) => {
							(e[t.value] = e[t.value] || []),
								e[t.value].push(i.buildFrom(t.id, t.length));
						}),
						Object.keys(e).forEach((t) => {
				...
				return (
					(n = n.map((e) => i.buildFrom(e.id, e.length))), this.buildFrom(n)
				);
			}),
				(t.lookUp = t.lookup);
		}),
	...
	var Er = {
		...
		Hr = k(function (e, t) {
			const r = function (e) {
				...
				a = function (e, t) {
					let r = ot(e, t.world)[0],
						a = t.buildFrom([r]);
					return a.tagger(), (t.list = a.list), t;
				};
			(t.append = function (e = '') {
				return e
					? this.found
						? (this.uncache(),
						  this.list.forEach((t) => {
								...
								r(e) && 'Doc' === e.isA
									? (a = e.list[0].clone())
									: 'string' == typeof e &&
									  (a = ot(e, this.world, this.pool())[0]),
									this.buildFrom([a]).tagger(),
									t.append(a, this);
						  }),
						  this)
						: a(e, this)
				...
				(t.concat = function () {
					...
					for (let t = 0; t < arguments.length; t++) {
						let r = arguments[t];
						if ('string' == typeof r) {
							let t = ot(r, this.world);
							e = e.concat(t);
						} else
							'Doc' === r.isA
								? (e = e.concat(r.list))
								: 'Phrase' === r.isA && e.push(r);
					}
					return this.buildFrom(e);
				}),
				(t.delete = function (e) {
					...
					return (
						e && (t = this.match(e)),
						t.list.forEach((e) => e.delete(this)),
						this
					);
				}),
				(t.remove = t.delete);
		});
	const jr = { clean: !0, reduced: !0, root: !0 };
	var Nr = {
		text: function (e) {
			e = e || {};
			let t = !1;
			...
			return (
				(!0 !== jr[e] && !0 !== e.reduced && !0 !== e.clean && !0 !== e.root) ||
					(r = r.trim()),
				r
			);
		},
					...
					t.forEach((e) => {
						e.terms.forEach((e) => {
							...
							(e.offset = {
								...
								start:
									e.terms[0].offset.start - e.text.indexOf(e.terms[0].text),
								length: e.text.length,
							});
					});
		},
		Fr = k(function (e, t) {
			const r = { text: !0, terms: !0, trim: !0 };
			(t.json = function (e = {}) {
				...
				let t = this.list.map((t) => t.json(e, this.world));
				if (
					...
					this.list.forEach((t) => {
						...
						this.list.forEach((r, a) => {
							t[a].count = e[r.text('reduced')];
						});
				}
				if (e.unique) {
					let e = {};
					t = t.filter((t) => !0 !== e[t.reduced] && ((e[t.reduced] = !0), !0));
				}
				return t;
			}),
				(t.data = t.json);
			...
			out: function (e) {
				...
				if ('array' === e)
					return this.json({ terms: !1 })
						.map((e) => e.text)
						.filter((e) => e);
				if ('freq' === e || 'frequency' === e) return Br(this);
				if ('terms' === e) {
					let e = [];
					return (
				...
				return 'tags' === e
					? this.list.map((e) =>
							e
								...
								.reduce(
									(e, t) => (
										(e[t.clean || t.implicit] = Object.keys(t.tags)), e
									),
									{}
								)
					  )
	...
	(zr.alphabetical = zr.alpha), (zr.wordcount = zr.wordCount);
	const Ir = {
		index: !0,
		sequence: !0,
		seq: !0,
	...
	var Mr = {
		...
		unicode: function (e) {
			e.forEach((e) => {
				!0 !== e.isImplicit() && (e.text = n(e.text));
			});
		},
		quotations: function (e) {
			e.forEach((e) => {
				(e.post = e.post.replace(Vr, '')), (e.pre = e.pre.replace(Vr, ''));
			});
		},
		adverbs: function (e) {
			e.match('#Adverb')
	...
	Lr.heavy = Object.assign({}, Lr.medium, {
		possessives: !0,
		verbs: !0,
		nouns: !0,
		honorifics: !0,
	...
	var Sr = {
			normalize: function (e) {
				'string' == typeof (e = e || {}) && (e = Lr[e] || {}),
					(e = Object.assign({}, Jr, e)),
					this.uncache();
				let t = this.termList();
				return (
					e.case && this.toLowerCase(),
					e.whitespace && Mr.whitespace(this),
					e.unicode && Mr.unicode(t),
					e.punctuation && Mr.punctuation(t),
					e.emoji && this.remove('(#Emoji|#Emoticon)'),
					e.acronyms && this.acronyms().strip(),
					e.abbreviations && Mr.abbreviations(this),
					(e.contraction || e.contractions) && this.contractions().expand(),
					e.parentheses && this.parentheses().unwrap(),
					(e.quotations || e.quotes) && Mr.quotations(t),
					e.adverbs && Mr.adverbs(this),
		...
		_r = k(function (e, t) {
			(t.splitOn = function (e) {
				...
				return (
					this.list.forEach((e) => {
						let a = e.match(t);
						if (0 === a.length) return void r.push(e);
						let n = e;
						a.forEach((e) => {
							let t = n.splitOn(e);
							t.before && r.push(t.before),
								t.match && r.push(t.match),
								(n = t.after);
						}),
							n && r.push(n);
					}),
					...
					return (
						this.list.forEach((e) => {
							...
							a.forEach((e) => {
								let t = n.splitOn(e);
								t.before && t.match
									? ((t.before.length += t.match.length), r.push(t.before))
									: t.match && r.push(t.match),
									(n = t.after);
							}),
								n && r.push(n);
	...
	var qr = {
			toLowerCase: function () {
				return Kr(this, 'toLowerCase');
			},
			toUpperCase: function () {
				return Kr(this, 'toUpperCase');
			},
			toTitleCase: function () {
				return Kr(this, 'toTitleCase');
			},
	...
	[
		...
		(Yr.emojis = Yr.emoji),
		(Yr.atmentions = Yr.atMentions),
		(Yr.words = Yr.terms),
		(Yr.phoneNumbers = function (e) {
		...
		(Yr.things = Yr.entities),
		(Yr.topics = Yr.entities);
	var ea = Yr;
	const ta = /^(under|over)-?/,
		ra = function (e, t, r) {
			let a = r.words,
	...
	var oa = [
		...
		[
			/^[a-z0-9./]+\.(com|net|gov|org|ly|edu|info|biz|ru|jp|de|in|uk|br)/,
			'Url',
		],
		[/^'[0-9]{2}$/, 'Year'],
	...
	const sa = /^[IVXLCDM]{2,}$/,
		la = /^M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})$/;
	const ua = 'Adjective',
		ca = 'Infinitive',
		ha = 'PresentTense',
		da = 'Singular',
	...
	var wa = {
		...
		c: [[/.[^aeiou]ic$/, ua]],
		d: [
			[/[aeiou](pp|ll|ss|ff|gg|tt|rr|bb|nn|mm)ed$/, ga],
			[/.[aeo]{2}[bdgmnprvz]ed$/, ga],
			[/.[aeiou][sg]hed$/, ga],
			[/.[aeiou]red$/, ga],
			[/.[aeiou]r?ried$/, ga],
			[/.[bcdgtr]led$/, ga],
	...
	var Ba = [
		null,
		null,
		{ ea: $a, ia: xa, ic: ka, ly: Ea, "'n": Na, "'t": Na },
		{
			oed: Pa,
			ued: Pa,
			xed: Pa,
		...
		{ auskas: Fa, keeper: ja, logist: ja, teenth: 'Value' },
		{ opoulos: Fa, borough: 'Place', sdottir: Fa },
	];
	var Ga = {
		':(': !0,
		':)': !0,
	...
	const Ia = {
		...
		punctuation: function (e, t, r) {
			...
			ia.test(a.text) && a.tag('Unit', 'per-sec', r);
		},
		regex: function (e, t) {
			let r = e.text;
			for (let a = 0; a < oa.length; a += 1)
				if (!0 === oa[a][0].test(r)) {
					e.tagSafe(oa[a][1], 'prefix #' + a, t);
					break;
				}
			e.text.length >= 2 &&
				sa.test(r) &&
		...
		suffix: function (e, t) {
			!(function (e, t) {
				...
				for (let n = a; n > 1; n -= 1) {
					...
					if (!0 === Ba[a.length].hasOwnProperty(a)) {
						let r = Ba[a.length][a];
		...
		emoji: (e, t) => {
			...
			(r = r.trim()),
				...
				!0 ===
					...
					(e.pre = e.pre.replace(':', '')),
					(e.post = e.post.replace(':', ''))),
				e.text.match(za) && (e.tag('Emoji', 'unicode-emoji', t), (e.text = r)),
				!0 === ((a = (a = r).replace(/^[:;]/, ':')), Ga.hasOwnProperty(a)) &&
	...
	var Oa = function (e, t) {
		...
		for (let e = 0; e < t.length; e += 1) {
			let a = t[e];
			Ia.punctuation(t, e, r), Ia.regex(a, r), Ia.suffix(a, r), Ia.emoji(a, r);
		}
		return e;
	};
	var Ta = {
	...
	const Va = Object.keys(Ta.afterThisPos),
		Ma = Object.keys(Ta.beforeThisPos);
	var Ja = function (e, t) {
		for (let r = 0; r < e.length; r += 1) {
			...
			let n = e[r - 1];
			if (n) {
				if (!0 === Ta.afterThisWord.hasOwnProperty(n.clean)) {
					let e = Ta.afterThisWord[n.clean];
					a.tag(e, 'after-' + n.clean, t);
					continue;
				}
				let e = Va.find((e) => n.tags[e]);
				if (void 0 !== e) {
					let r = Ta.afterThisPos[e];
					a.tag(r, 'after-' + e, t);
					continue;
				}
			}
			let i = e[r + 1];
			if (i) {
				if (!0 === Ta.beforeThisWord.hasOwnProperty(i.clean)) {
					let e = Ta.beforeThisWord[i.clean];
					a.tag(e, 'before-' + i.clean, t);
					continue;
				}
				let e = Ma.find((e) => i.tags[e]);
				if (void 0 !== e) {
					let r = Ta.beforeThisPos[e];
					a.tag(r, 'before-' + e, t);
					continue;
				}
			}
	...
	const Ka = /^(re|un)-?[a-z\u00C0-\u00FF]/,
		qa = /^(re|un)-?/;
	var Wa = function (e, t) {
		let r = t.words;
		e.forEach((e) => {
			if (!0 !== e.isKnown() && !0 === Ka.test(e.clean)) {
				let a = e.clean.replace(qa, '');
				a &&
					a.length > 3 &&
					void 0 !== r[a] &&
	...
	var Xa = function (e, t) {
		if (e.tags.Noun && !e.tags.Acronym) {
			...
			if (Ua.find((t) => e.tags[t])) return;
			if (Ra.isPlural.find((e) => e.test(r)))
				return void e.tag('Plural', 'plural-rules', t);
			if (Ra.isSingular.find((e) => e.test(r)))
				return void e.tag('Singular', 'singular-rules', t);
			if (!0 === /s$/.test(r)) {
				if (Qa.find((e) => e.test(r))) return;
				return void e.tag('Plural', 'plural-fallback', t);
			}
			if (Za.find((e) => e.test(r))) return;
	...
	const nn = {
		...
		organizations: function (e, t) {
			for (let r = 0; r < e.length; r += 1) {
				let a = e[r];
				if (void 0 !== Ya[a.clean] && !0 === Ya.hasOwnProperty(a.clean)) {
					let n = e[r - 1];
					if (void 0 !== n && !0 === en(n)) {
					...
					let i = e[r + 1];
					if (void 0 !== i && 'of' === i.clean && e[r + 2] && en(e[r + 2])) {
		...
		acronyms: function (e, t) {
			e.forEach((e) => {
				!0 !== e.tags.RomanNumeral &&
					(!0 === rn.test(e.text) && e.tag('Acronym', 'period-acronym', t),
					e.isUpperCase() &&
					(function (e, t) {
						let r = e.reduced;
						return (
	...
	var un = function (e, t) {
		if (!0 === ln.hasOwnProperty(e.clean)) return ln[e.clean];
		...
		if (!0 === sn.test(e.clean)) {
			return [e.clean.replace(sn, ''), 'not'];
		}
		return null;
	};
	const cn = /([a-z\u00C0-\u00FF]+)[\u0027\u0060\u00B4\u2018\u2019\u201A\u201B\u2032\u2035\u2039\u203A]([a-z]{1,2})$/i,
		hn = { ll: 'will', ve: 'have', re: 'are', m: 'am', "n't": 'not' };
	var dn = function (e) {
		let t = e.text.match(cn);
		return null === t
			? null
			: hn.hasOwnProperty(t[2])
			? [t[1], hn[t[2]]]
			: null;
	};
	const gn = {
	...
	var pn = function (e) {
		return gn.hasOwnProperty(e.clean) ? gn[e.clean] : null;
	};
	const mn = /([a-z\u00C0-\u00FF]+)[\u0027\u0060\u00B4\u2018\u2019\u201A\u201B\u2032\u2035\u2039\u203A]s$/i,
		fn = { that: !0, there: !0 },
		bn = { here: !0, there: !0, everywhere: !0 };
		...
		if (null !== a) {
			if (
				...
				((e, t) => {
					...
					if (fn.hasOwnProperty(e.reduced)) return !1;
					let r = t.get(e.next);
					if (!r) return !0;
					if (r.tags.Verb) return !!r.tags.Infinitive || !!r.tags.PresentTense;
					if (r.tags.Noun) return !0 !== bn.hasOwnProperty(r.reduced);
					let a = t.get(r.next);
					return (
	...
	const An = /^([0-9.]{1,3}[a-z]{0,2}) ?[-–—] ?([0-9]{1,3}[a-z]{0,2})$/i,
		Dn = /^([0-9][0-9]?(:[0-9][0-9])?(am|pm)?) ?[-–—] ?([0-9][0-9]?(:[0-9][0-9])?(am|pm)?)$/i;
	var $n = function (e) {
		if (!0 === e.tags.PhoneNumber) return null;
		let t = e.text.match(An);
		return null !== t
			? [t[1], 'to', t[2]]
			: ((t = e.text.match(Dn)), null !== t ? [t[1], 'to', t[4]] : null);
	};
	const Pn = /^(l|c|d|j|m|n|qu|s|t)[\u0027\u0060\u00B4\u2018\u2019\u201A\u201B\u2032\u2035\u2039\u203A]([a-z\u00C0-\u00FF]+)$/i,
		En = {
			l: 'le',
			c: 'ce',
			d: 'de',
	...
	var Hn = function (e) {
		let t = e.text.match(Pn);
		if (null === t || !1 === En.hasOwnProperty(t[1])) return null;
		let r = [En[t[1]], t[2]];
	...
	const jn = /^[0-9]+$/,
		...
		xn = /^[0-9:]+(am|pm)?$/,
		Fn = function (e, t) {
			let r = ot(e.join(' '), t.world, t.pool())[0],
				a = r.terms();
			aa(a, t.world);
			let n = a[0];
			return (
	...
	var Gn = function (e) {
		...
		return (
			t.found &&
				...
				t.match('[#Infinitive] (it|some)', 0).tag('Imperative', 'do-it')),
			(t = (function (e, t) {
	...
	var Vn = [
		...
		{ match: `in [${Tn}]`, group: 0, tag: 'Date', reason: 'in-june' },
		{ match: `during [${Tn}]`, group: 0, tag: 'Date', reason: 'in-june' },
		{ match: `on [${Tn}]`, group: 0, tag: 'Date', reason: 'in-june' },
		{ match: `by [${Tn}]`, group: 0, tag: 'Date', reason: 'by-june' },
		{ match: `after [${Tn}]`, group: 0, tag: 'Date', reason: 'after-june' },
		{ match: `#Date [${Tn}]`, group: 0, tag: 'Date', reason: 'in-june' },
		{ match: Tn + ' #Value', tag: 'Date', reason: 'june-5th' },
		{ match: Tn + ' #Date', tag: 'Date', reason: 'june-5th' },
		{
			match: Tn + ' #ProperNoun',
			tag: 'Person',
			reason: 'june-smith',
		...
		{
			match: Tn + ' #Acronym? (#ProperNoun && !#Month)',
			tag: 'Person',
	...
	const Mn = `(${On.personAdjective.join('|')})`;
	var Jn = [
			{
			...
			{ match: Mn + ' #Person', tag: 'Person', reason: 'randy-smith' },
			{
				match: Mn + ' #Acronym? #ProperNoun',
				tag: 'Person',
				reason: 'rusty-smith',
			},
			{
	...
	var Sn = [
			...
			{
				match: `[${`(${On.adverbAdjective.join('|')})`}] #Adjective`,
				group: 0,
				tag: 'Adverb',
				reason: 'dark-green',
			},
	...
	var qn = [
		...
		{ match: `#Modal [${Kn}]`, group: 0, tag: 'Verb', reason: 'would-mark' },
		{ match: `#Adverb [${Kn}]`, group: 0, tag: 'Verb', reason: 'really-mark' },
		{
			match: '(to|#Modal) [mark]',
			group: 0,
			tag: 'PresentTense',
		...
		{ match: Kn + ' #Person', tag: 'Person', reason: 'rob-smith' },
		{
			match: Kn + ' #Acronym #ProperNoun',
			tag: 'Person',
			reason: 'rob-a-smith',
		},
		{
	...
	const Rn = `(${On.personNoun.join('|')})`,
		Un = `(${On.personMonth.join('|')})`;
	var Qn = [
		{
		...
		{ match: Rn + ' #Person', tag: 'Person', reason: 'ray-smith', safe: !0 },
		{
			match: Rn + ' #Acronym? #ProperNoun',
			tag: 'Person',
			reason: 'ray-a-smith',
			safe: !0,
		},
		{
			match: `#Infinitive #Determiner? #Adjective? #Noun? (to|for) [${Un}]`,
			group: 0,
			tag: 'Person',
			reason: 'ambig-person',
		},
		...
		{ match: `[${Un}] #Modal`, group: 0, tag: 'Person', reason: 'ambig-modal' },
		{ match: '[may] be', group: 0, tag: 'Verb', reason: 'may-be' },
		{ match: `#Modal [${Un}]`, group: 0, tag: 'Person', reason: 'modal-ambig' },
		{ match: `#Copula [${Un}]`, group: 0, tag: 'Person', reason: 'is-may' },
		{ match: `[${Un}] #Copula`, group: 0, tag: 'Person', reason: 'may-is' },
		{ match: `that [${Un}]`, group: 0, tag: 'Person', reason: 'that-month' },
		{ match: `with [${Un}]`, group: 0, tag: 'Person', reason: 'with-month' },
		{ match: `for [${Un}]`, group: 0, tag: 'Person', reason: 'for-month' },
		{ match: `this [${Un}]`, group: 0, tag: 'Month', reason: 'this-may' },
		{ match: `next [${Un}]`, group: 0, tag: 'Month', reason: 'next-may' },
		{ match: `last [${Un}]`, group: 0, tag: 'Month', reason: 'last-may' },
		{ match: `#Date [${Un}]`, group: 0, tag: 'Month', reason: 'date-may' },
		{ match: `[${Un}] the? #Value`, group: 0, tag: 'Month', reason: 'may-5th' },
		{
			match: `#Value of [${Un}]`,
			group: 0,
			tag: 'Month',
		...
		{
			match: `[${`(${On.personPlace.join('|')})`}] (#ProperNoun && !#Place)`,
			group: 0,
			tag: 'FirstName',
	...
	Zn.forEach((e) => {
		...
		t.length > 0 ? (Xn = Xn.concat(t)) : Xn.push(e);
	}),
		Xn.forEach(
			(e) => (
	...
	const ci = {
		...
		di = [/^onc?e/i, /^u[bcfhjkqrstn][aeiou]/i, /^eul/i];
	var gi = function (e) {
		if (e.has('#Person') || e.has('#Place')) return '';
		if (e.has('#Plural')) return 'the';
		let t = e.text('normal').trim();
		if (ci.hasOwnProperty(t)) return ci[t];
		let r = t.substr(0, 1);
		if (e.has('^@isAcronym') && hi.hasOwnProperty(r)) return 'an';
		for (let e = 0; e < di.length; e++) if (di[e].test(t)) return 'a';
	...
	var fi = function (e) {
		return (
			!pi.isSingular.find((t) => t.test(e)) &&
			(!0 === mi.test(e) || !!pi.isPlural.find((t) => t.test(e)) || null)
		);
	};
	const bi = {
		he: 'his',
	...
	var yi = function (e) {
		...
		return bi.hasOwnProperty(t)
			? (e.replaceWith(bi[t], !0), void e.tag('Possessive', 'toPossessive'))
			: /s$/.test(t)
			? ((t += "'"),
			  e.replaceWith(t, !0),
	...
	var wi = {
		...
		hasPlural: function () {
			return this.filter((e) => ui(e));
		},
		toPlural: function (e) {
			let t = this.world.transforms.toPlural;
			return (
				this.forEach((r) => {
					if (r.has('#Plural') || !1 === ui(r)) return;
					let a = vi(r).main,
						n = a.text('reduced');
					if (
						(a.has('#Singular') || !0 !== fi(n)) &&
		...
		toSingular: function (e) {
			...
			return (
				this.forEach((r) => {
					if (r.has('^#Singular+$') || !1 === ui(r)) return;
					let a = vi(r).main,
						n = a.text('reduced');
					if (
						(a.has('#Plural') || !0 === fi(n)) &&
		...
		if (!e.negative.found) {
			...
			if (r.has('(#Copula|will|has|had|do)')) r.append('not');
				...
				if (r.has('#PresentTense')) {
					...
					return (
						r.replaceWith(a, !0),
						void (xi(e) ? r.prepend('do not') : r.prepend('does not'))
					);
				}
				if (r.has('#Gerund')) {
					let a = Ni(e, t);
				...
				xi(e) ? r.prepend('does not') : r.prepend('do not');
			}
		}
	};
	var Ci = function (e) {
	...
	var Gi = (e) => {
		...
		return (
			!0 === t && ((n.PresentTense = 'am'), (n.Infinitive = 'am')),
			r &&
				((n.PastTense = 'were'),
				(n.PresentTense = 'are'),
				(n.Infinitive = 'are')),
	...
	var Ii = function (e, t) {
		...
		if (r.has('#Modal')) return zi(e);
		let a = e.verb.termList(0).hasHyphen(),
			n = Ni(e, t);
		if (!n) return {};
		let i = t.transforms.conjugate(n, t);
		if (((i.Infinitive = n), e.particle.found)) {
			let t = e.particle.text(),
				r = !0 === a ? '-' : ' ';
			Object.keys(i).forEach((e) => (i[e] += r + t));
		}
		const o = e.negative.found;
		return (
			o &&
			...
			i.FutureTense ||
				(i.FutureTense = o
					...
					: 'will ' + i.Infinitive),
			o && (i.Infinitive = 'not ' + i.Infinitive),
			i
		);
	};
	var Oi = {
	...
	const { toParticiple: Ti, useParticiple: Vi } = Oi,
		Mi = function (e) {
			return (
	...
	var Ji = {
			...
			return (
				this.forEach((t) => {
					...
					(a.parts = {}),
						...
						(a.conjugations = Ii(n, this.world)),
						r.push(a);
				}),
				null !== t ? r[t] : r
			);
		...
		isPlural: function () {
			...
			return (
				this.forEach((t) => {
					let r = Bi(t);
					!0 === xi(r, this.world) && e.push(t.list[0]);
				}),
				this.buildFrom(e)
			);
		},
		isSingular: function () {
			...
			return (
				this.forEach((t) => {
					let r = Bi(t);
					!1 === xi(r, this.world) && e.push(t.list[0]);
				}),
				this.buildFrom(e)
			);
		},
		...
		toPastTense: function () {
			return (
				this.forEach((e) => {
					let t = Bi(e);
					if (Vi(t)) return void Ti(t, this.world);
					...
					let r = Ii(t, this.world).PastTense;
					r && ((t = Mi(t)), t.verb.replaceWith(r, !1));
				}),
				this
			);
		},
		...
		toFutureTense: function () {
			return (
				this.forEach((e) => {
					let t = Bi(e);
					if (Vi(t)) return;
					let r = Ii(t, this.world).FutureTense;
					r &&
						((t = Mi(t)),
						t.auxiliary.remove('#Modal'),
			...
			return (
				...
				(e.prototype.verbs = function (e) {
					...
					let a = r.match('(#Adverb && @hasComma) #Adverb'),
						...
						i = n.match('#PastTense #Gerund');
					return (
						i.has('(been|am|#Auxiliary) #Gerund') ||
							(n = n.splitBefore(i.match('#Gerund'))),
						(n = n.concat(a)),
						n.sort('index'),
						(n = n.if('#Verb')),
	...
	var Si = function (e) {
		return (
			Object.keys(ea).forEach((t) => (e.prototype[t] = ea[t])),
			Li.forEach((t) => t(e)),
			e
		);
	};
	const _i = { misc: Xr, selections: ea };
	class Ki {
		constructor(e, t, r) {
			(this.list = e),
	...
	(Ki.prototype.buildFrom = function (e) {
		return (e = e.map((e) => e.clone(!0))), new Ki(e, this, this.world);
	}),
		(Ki.prototype.fromText = function (e) {
			let t = ot(e, this.world, this.pool());
			return this.buildFrom(t);
		}),
		Object.assign(Ki.prototype, _i.misc),
		Object.assign(Ki.prototype, _i.selections),
		Si(Ki);
	const qi = {
		untag: 'unTag',
		and: 'match',
	...
	Object.keys(qi).forEach((e) => (Ki.prototype[e] = Ki.prototype[qi[e]]));
	var Wi = Ki;
	var Ri = function (e) {
		let t = e.termList();
		return (
	...
	return (function e(t) {
		...
		return (
			(a.tokenize = function (e = '', t) {
				...
				let n = ot(e, a),
					i = new Wi(n, null, a);
				return (t || i.world.taggers.length > 0) && Ri(i), i;
			}),
			(a.extend = function (e) {
				return e(Wi, r, this, Ve, Z, Je), this;
			}),
			(a.fromJSON = function (e) {
				let t = st(e, r);
				return new Wi(t, null, r);
			}),
			(a.clone = function () {
				return e(r.clone());
			}),
